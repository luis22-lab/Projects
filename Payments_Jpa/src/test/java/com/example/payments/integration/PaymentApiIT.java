...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)/*Levanta un servidor embebido llamadas http(restTemplate..)*/
...
class PaymentApiIT {
    ...
    void tesPostPayment() {
        ...
        final var saved = paymentRepository.findOneByRequestId("0000001").orElseThrow();
